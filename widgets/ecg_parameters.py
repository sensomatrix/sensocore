...
class ECGSimulationParameters(QDockWidget):
		...
		def initP(self):
			...
			initValues = [185, 178, 2369]
			minValues = [100, 100, 2000]
			maxValues = [200, 300, 3000]

			self.initSliders(initValues, minValues, maxValues, self.p_slider)
